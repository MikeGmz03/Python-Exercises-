...
#XML | como dividir un XML determinado y mostrar ciertos campos 

#Primer programa con XML.
import xml.etree.ElementTree as ET #Librería que hace casi todo en XML
data = '''<person> 
    <name>Chuck</name>
    <phone type="intl">
        +1 734 303 4456
